...
def tax_calculator(total_sales):
  ...
  total_sales_tax = total_county_tax + total_state_tax

  return total_state_tax, total_county_tax, total_sales_tax

total_sales = float(input("Enter total sales this month: $"))

total_state_tax, total_county_tax, total_sales_tax = tax_calculator(total_sales)

print("Total state tax: $", format(total_state_tax, '.2f'))
print("Total county tax: $", format(total_county_tax, '.2f'))
